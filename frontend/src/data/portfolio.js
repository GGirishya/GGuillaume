...
export const EXPERIENCE = [
  {
    ...
    location: "Remote",
    bullets: [
      "Built responsive websites following product docs while meeting WCAG accessibility standards.",
      "Produced high-fidelity prototypes in Figma; collaborated with managers to validate UI/UX decisions.",
      "Shipped real-world projects for Airbnb, Netflix, Waymark, Publicis Sapient, and Marriott Homes & Villas.",
    ],
    tags: ["React", "Figma", "WCAG", "UI/UX"],
  },
  {
...
export const SKILL_GROUPS = [
  {
    label: "Languages",
    items: ["JavaScript", "Python", "Java", "C / C++", "SQL", "HTML", "CSS"],
  },
  {
    label: "Frontend",
    items: ["React.js", "DOM APIs", "Tailwind", "Figma", "WCAG / a11y"],
  },
  {
    label: "Backend",
  ...
  {
    label: "Tools & Other",
    items: ["Git", "AI agents", "UI/UX design", "MS Office Suite"],
  },
];
...
export const CERTS = [
  "Cybersecurity Awareness Certificate — NASBA",
  "Cybersecurity Threat Landscape Certification",
  "Professional-level Web Dev — HTML, CSS, JavaScript",
  "Web Accessibility for Developers — LinkedIn Learning",
];

export const AWARDS = [
  {
    title: "People's Choice Award — Vicki Stanton Public Speaking Showcase",
